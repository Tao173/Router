...
#主机名右上角符号233
#sed -i 's/233/233/g' package/lean/luci-theme-argon_armygreen/luasrc/view/themes/argon_armygreen/header.htm
#修改主题多余版本信息
...
cat files/mydefault >> package/lean/default-settings/files/zzz-default-settings  && rm -rf files/mydefault
sed -i '5a\msgid "Source Code"' feeds/luci/modules/luci-base/po/zh-cn/base.po #添加汉化
